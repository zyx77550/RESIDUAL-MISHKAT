        ...
        <div ref={scrollTrackRef} className="absolute right-0 top-0 bottom-0 w-16 z-50 pointer-events-none">
          ...
          >
            ...
            <div 
              ...
              className={`pointer-events-auto absolute right-0 top-0 w-12 h-20 bg-linear-to-br from-[#fdfbf7]/90 to-[#ecdac1]/80 backdrop-blur-md rounded-l-2xl shadow-[-4px_0_20px_rgba(218,165,32,0.15)] flex items-center justify-center transition-transform duration-300 ease-out border border-r-0 border-white/90 ${isScrollLocked ? 'opacity-30 cursor-not-allowed' : 'cursor-grab'}`}
              style={{ transform: `translateX(${tabTranslateX}px)` }}
            >
              <div className="absolute left-0 top-1/4 h-1/2 w-[3px] bg-linear-to-b from-amber-300 to-amber-500 rounded-r-sm shadow-[1px_0_4px_rgba(245,158,11,0.3)]"></div>
